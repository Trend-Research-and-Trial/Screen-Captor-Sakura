...
class ManualCreation:
    ...
    def __init__(self, file_name):
        ...
        frame_button_canvas.grid(
            row=2, column=0, columnspan=3, padx=20, pady=5, sticky=tkinter.W)
    ...
    def __next(self):
        ...
        if self.canvas.coords("red_rectangle") != []:
            self.rectangle_start_x, self.rectangle_start_y, self.rectangle_end_x, self.rectangle_end_y = [
                round(n / self.SCALED_POINT) for n in self.canvas.coords("red_rectangle")
            ]
    ...
    def __draw_rectangle(self, event):
        ...
        self.canvas.coords("red_rectangle", self.scaled_rectangle_start_x,
